...
def scenario_iterator_non_interactive(
    path: str,
) -> Iterator[Tuple[Scenario, PlanningProblemSet]]:
    """
    ...
    return (
        CommonRoadFileReader(scenario_path).open() for scenario_path in scenario_paths
    )
